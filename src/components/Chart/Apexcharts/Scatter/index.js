    ...
    return (
        <>
            <Container fluid>
                ...
                <Breadcrumbs  mainTitle="Scatter" title="Chart" path={["Apexchart","Scatter"]} icon={<i class="ph-duotone  ph-chart-pie-slice f-s-16"></i>}/>
                                ...
                                <ApexCharts
                                    ...
                                    options={{
                                        ...
                                        fill: {
                                            ...
                                            opacity: 1,
                                            image: {
                                                src: ['/images/icons/messenger.png', '/images/icons/instagram.png'],
                                                width: 40,
                                                height: 40
                                            }
                                        },
